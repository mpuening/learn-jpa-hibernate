...
@SpringBootTest
public class LearnJPAEclipseLinkApplicationTests {
	...
	public void testCreateNewEntity() {
		...
		// Other count is getting identities
		...
		MatcherAssert.assertThat(proxyDataSource, DataSourceAssertMatchers.otherCount(1));
	}
